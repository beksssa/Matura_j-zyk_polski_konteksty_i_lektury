...
const data = {
  ...
  motifs: [
    { id: "motywnarodowy", name: "Motyw Narodowy", description: "Problematyka kondycji narodu", books: ["wesele"], aliases: ["naród", "motyw narodu"], images: [{ src: "images/motywy/naród/wallpaperflare.com_wallpaper.jpg" }], poems: [
    { 
      title: "Słowa Chochoła", 
      author: "Stanisław Wyspiański", 
      src: "poems/motywy/symbolizm/chochol.txt" 
    }
  ] },
