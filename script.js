...
const data = {
  ...
  motifs: [
    ...
    { id: "motywzyda", name: "Motyw Żyda", description: "Obraz mniejszości żydowskiej oraz problem uprzedzeń i asymilacji", books: [], aliases: ["żyd", "zyd", "motyw żyda", "motyw zyda"], images: [], poems: [] },
    { id: "motywartysty", name: "Motyw Artysty", description: "Wyjątkowość twórcy i konflikt między sztuką a społeczeństwem", books: [], aliases: ["artysta", "motyw artysty", "twórca", "tworca"], images: [], poems: [] },
    { id: "motywarystokracji", name: "Motyw Arystokracji", description: "Krytyka uprzywilejowanych warstw i ich oderwania od rzeczywistości", books: [], aliases: ["arystokracja", "motyw arystokracji", "arystokraci"], images: [], poems: [] },
    { id: "motywbiedy", name: "Motyw Biedy", description: "Degradacja człowieka wynikająca z ubóstwa i nierówności społecznych", books: [], aliases: ["bieda", "motyw biedy", "ubóstwo", "ubostwo"], images: [], poems: [] },
    { id: "motywboga", name: "Motyw Boga", description: "Poszukiwanie sensu życia i relacji człowieka z absolutem", books: [], aliases: ["bóg", "bog", "motyw boga", "motyw boga"], images: [], poems: [] },
    ...
    { id: "motywbuntu", name: "Motyw Buntu", description: "Sprzeciw wobec norm społecznych, władzy lub przeznaczenia", books: [], aliases: ["bunt", "motyw buntu", "sprzeciw"], images: [], poems: [] },
    ...
    { id: "motywcierpienia", name: "Motyw Cierpienia", description: "Ból fizyczny lub psychiczny jako doświadczenie kształtujące człowieka", books: [], aliases: ["cierpienie", "motyw cierpienia", "ból", "bol"], images: [], poems: [] },
    { id: "motywdomu", name: "Motyw Domu", description: "Dom jako symbol bezpieczeństwa, tradycji i tożsamości", books: [], aliases: ["dom", "motyw domu", "ognisko domowe"], images: [], poems: [] },
    { id: "motywdworku", name: "Motyw Dworku", description: "Idealizacja życia szlacheckiego i przywiązania do tradycji", books: [], aliases: ["dworek", "motyw dworku", "dwór", "dwor"], images: [], poems: [] },
    ...
    { id: "motywfatumprzeznaczenia", name: "Motyw Fatum/Przeznaczenia", description: "Nieuchronność losu determinującego życie bohatera", books: [], aliases: ["fatum", "przeznaczenie", "motyw fatum", "motyw przeznaczenia"], images: [], poems: [] },
    { id: "motywfilantropii", name: "Motyw Filantropii", description: "Bezinteresowna pomoc innym jako wyraz humanizmu", books: [], aliases: ["filantropia", "motyw filantropii", "pomoc innym"], images: [], poems: [] },
    { id: "motywkariery", name: "Motyw Kariery", description: "Dążenie do sukcesu społecznego i zawodowego", books: [], aliases: ["kariera", "motyw kariery", "awans społeczny", "awans spoleczny"], images: [], poems: [] },
    { id: "motywkobiety", name: "Motyw Kobiety", description: "Różnorodne role kobiet i społeczne wyobrażenia o kobiecości", books: [], aliases: ["kobieta", "motyw kobiety", "kobiecość", "kobiecosc"], images: [], poems: [] },
    { id: "motywkonfliktu", name: "Motyw Konfliktu", description: "Starcie przeciwstawnych racji, wartości lub interesów", books: [], aliases: ["konflikt", "motyw konfliktu", "spór", "spor"], images: [], poems: [] },
    { id: "motywkonfliktupokolen", name: "Motyw Konfliktu Pokoleń", description: "Różnice światopoglądowe między młodymi a starszymi", books: [], aliases: ["konflikt pokoleń", "konflikt pokolen", "motyw konfliktu pokoleń", "motyw konfliktu pokolen"], images: [], poems: [] },
    ...
    { id: "motywmilosci", name: "Motyw Miłości", description: "Uczucie jako źródło szczęścia, cierpienia lub przemiany bohatera", books: [], aliases: ["miłość", "milosc", "motyw miłości", "motyw milosci"], images: [], poems: [] },
    { id: "motywmiasta", name: "Motyw Miasta", description: "Miasto jako przestrzeń rozwoju, anonimowości i zepsucia", books: [], aliases: ["miasto", "motyw miasta", "metropolia"], images: [], poems: [] },
    { id: "motywmieszczanstwa", name: "Motyw Mieszczaństwa", description: "Obraz klasy średniej oraz jej aspiracji i ograniczeń", books: [], aliases: ["mieszczaństwo", "mieszczanstwo", "motyw mieszczaństwa", "motyw mieszczanstwa"], images: [], poems: [] },
    ...
    { id: "motywobyczajowitradycji", name: "Motyw Obyczajów i Tradycji", description: "Znaczenie norm społecznych i kulturowego dziedzictwa", books: [], aliases: ["obyczaje", "tradycja", "motyw obyczajów i tradycji", "motyw obyczajow i tradycji"], images: [], poems: [] },
    { id: "motywojca", name: "Motyw Ojca", description: "Autorytet rodzicielski i relacje ojca z dzieckiem", books: [], aliases: ["ojciec", "motyw ojca", "ojcostwo"], images: [], poems: [] },
    { id: "motywpatriotyzmu", name: "Motyw Patriotyzmu", description: "Miłość do ojczyzny i gotowość do poświęceń dla narodu", books: [], aliases: ["patriotyzm", "motyw patriotyzmu", "ojczyzna"], images: [], poems: [] },
    { id: "motywpieniadza", name: "Motyw Pieniądza", description: "Wpływ majątku na relacje międzyludzkie i moralność", books: [], aliases: ["pieniądz", "pieniadz", "motyw pieniądza", "motyw pieniadza"], images: [], poems: [] },
    { id: "motywposwiecenia", name: "Motyw Poświęcenia", description: "Rezygnacja z własnego dobra dla wyższych wartości", books: [], aliases: ["poświęcenie", "poswiecenie", "motyw poświęcenia", "motyw poswiecenia"], images: [], poems: [] },
    { id: "motywpodrozywedrowki", name: "Motyw Podróży/Wędrówki", description: "Poszukiwanie sensu życia i dojrzewanie bohatera", books: [], aliases: ["podróż", "podroz", "wędrówka", "wedrowka", "motyw podróży"], images: [], poems: [] },
    ...
    { id: "motywpolskiipolakow", name: "Motyw Polski i Polaków", description: "Refleksja nad tożsamością narodową i kondycją społeczeństwa", books: [], aliases: ["polska", "polacy", "motyw polski i polaków", "motyw polski i polakow"], images: [], poems: [] },
    { id: "motywpowstania", name: "Motyw Powstania", description: "Walka narodowowyzwoleńcza i jej konsekwencje", books: [], aliases: ["powstanie", "motyw powstania", "walka narodowowyzwoleńcza"], images: [], poems: [] },
    { id: "motywpracy", name: "Motyw Pracy", description: "Praca jako wartość budująca człowieka i społeczeństwo", books: [], aliases: ["praca", "motyw pracy", "wysiłek", "wysilek"], images: [], poems: [] },
    { id: "motywprzemiany", name: "Motyw Przemiany", description: "Wewnętrzna metamorfoza bohatera pod wpływem doświadczeń", books: [], aliases: ["przemiana", "motyw przemiany", "metamorfoza"], images: [], poems: [] },
    { id: "motywprzemijania", name: "Motyw Przemijania", description: "Ulotność życia i nieuchronność upływu czasu", books: [], aliases: ["przemijanie", "motyw przemijania", "upływ czasu", "uplyw czasu"], images: [], poems: [] },
    { id: "motywprzepowiedni", name: "Motyw Przepowiedni", description: "Zapowiedź przyszłych wydarzeń wpływająca na los bohatera", books: [], aliases: ["przepowiednia", "motyw przepowiedni", "proroctwo"], images: [], poems: [] },
    { id: "motywprzyjazni", name: "Motyw Przyjaźni", description: "Więź oparta na lojalności, wsparciu i zaufaniu", books: [], aliases: ["przyjaźń", "przyjazn", "motyw przyjaźni", "motyw przyjazni"], images: [], poems: [] },
    { id: "motywprzyrodynatury", name: "Motyw Przyrody/Natury", description: "Natura jako odbicie emocji i harmonii świata", books: [], aliases: ["przyroda", "natura", "motyw przyrody", "motyw natury"], images: [], poems: [] },
    { id: "motywrewolucji", name: "Motyw Rewolucji", description: "Gwałtowne przemiany społeczne i polityczne", books: [], aliases: ["rewolucja", "motyw rewolucji", "przewrót", "przewrot"], images: [], poems: [] },
    { id: "motywrodziny", name: "Motyw Rodziny", description: "Relacje rodzinne jako źródło wsparcia lub konfliktów", books: [], aliases: ["rodzina", "motyw rodziny", "więzi rodzinne", "wiezi rodzinne"], images: [], poems: [] },
    ...
    { id: "motywrycerza", name: "Motyw Rycerza", description: "Honor, odwaga i wierność ideałom", books: [], aliases: ["rycerz", "motyw rycerza", "rycerskość", "rycerskosc"], images: [], poems: [] },
    ...
    { id: "motywsamotnosci", name: "Motyw Samotności", description: "Osamotnienie jednostki i wyobcowanie ze społeczeństwa", books: [], aliases: ["samotność", "samotnosc", "motyw samotności", "motyw samotnosci"], images: [], poems: [] },
    ...
    { id: "motywspisku", name: "Motyw Spisku", description: "Tajne działania prowadzące do zmiany politycznej lub społecznej", books: [], aliases: ["spisek", "motyw spisku", "konspiracja"], images: [], poems: [] },
    ...
    { id: "motywsyna", name: "Motyw Syna", description: "Relacja syna z rodziną oraz proces dojrzewania", books: [], aliases: ["syn", "motyw syna", "dziecko"], images: [], poems: [] },
    { id: "motywszalenstwa", name: "Motyw Szaleństwa", description: "Utrata kontroli nad rozumem i emocjami", books: [], aliases: ["szaleństwo", "szalenstwo", "motyw szaleństwa", "motyw szalenstwa"], images: [], poems: [] },
    ...
    { id: "motywszkoly", name: "Motyw Szkoły", description: "Edukacja jako narzędzie rozwoju lub zniewolenia", books: [], aliases: ["szkoła", "szkola", "motyw szkoły", "motyw szkoly"], images: [], poems: [] },
    { id: "motywszlachty", name: "Motyw Szlachty", description: "Obraz warstwy szlacheckiej i jej tradycji", books: [], aliases: ["szlachta", "motyw szlachty", "szlachcic"], images: [], poems: [] },
    { id: "motywtanca", name: "Motyw Tańca", description: "Taniec jako symbol relacji społecznych lub emocji zbiorowych", books: [], aliases: ["taniec", "motyw tańca", "motyw tanca"], images: [], poems: [] },
    { id: "motywtotalitaryzmu", name: "Motyw Totalitaryzmu", description: "Zniewolenie jednostki przez system polityczny", books: [], aliases: ["totalitaryzm", "motyw totalitaryzmu", "dyktatura"], images: [], poems: [] },
    { id: "motywuczniaimistrza", name: "Motyw Ucznia i Mistrza", description: "Relacja oparta na przekazywaniu wiedzy i doświadczenia", books: [], aliases: ["uczeń i mistrz", "uczen i mistrz", "motyw ucznia i mistrza"], images: [], poems: [] },
    { id: "motywwladcy", name: "Motyw Władcy", description: "Obraz rządzącego i odpowiedzialności za państwo", books: [], aliases: ["władca", "wladca", "motyw władcy", "motyw wladcy"], images: [], poems: [] },
    { id: "motywwladzy", name: "Motyw Władzy", description: "Mechanizmy sprawowania kontroli i wpływu na ludzi", books: [], aliases: ["władza", "wladza", "motyw władzy", "motyw wladzy"], images: [], poems: [] },
    { id: "motywwinyikary", name: "Motyw Winy i Kary", description: "Moralne konsekwencje popełnionych czynów", books: [], aliases: ["wina i kara", "motyw winy i kary", "kara", "wina"], images: [], poems: [] },
    { id: "motywwojny", name: "Motyw Wojny", description: "Tragizm konfliktów zbrojnych i ich wpływ na człowieka", books: [], aliases: ["wojna", "motyw wojny", "konflikt zbrojny"], images: [], poems: [] },
    { id: "motywwolnosci", name: "Motyw Wolności", description: "Dążenie jednostki lub narodu do niezależności", books: [], aliases: ["wolność", "wolnosc", "motyw wolności", "motyw wolnosci"], images: [], poems: [] },
    { id: "motywwsi", name: "Motyw Wsi", description: "Idealizacja lub krytyka życia wiejskiego i chłopstwa", books: [], aliases: ["wieś", "wies", "motyw wsi", "życie na wsi"], images: [], poems: [] },
    { id: "motywzla", name: "Motyw Zła", description: "Obecność destrukcyjnych sił w świecie i człowieku", books: [], aliases: ["zło", "zlo", "motyw zła", "motyw zla"], images: [], poems: [] },
    { id: "motywzbrodni", name: "Motyw Zbrodni", description: "Przekroczenie norm moralnych i jego konsekwencje", books: [], aliases: ["zbrodnia", "motyw zbrodni", "przestępstwo", "przestepstwo"], images: [], poems: [] },
    { id: "motywzdrady", name: "Motyw Zdrady", description: "Złamanie lojalności wobec bliskich, idei lub ojczyzny", books: [], aliases: ["zdrada", "motyw zdrady", "nielojalność", "nielojalnosc"], images: [], poems: [] },
    { id: "motywzemsty", name: "Motyw Zemsty", description: "Pragnienie odwetu prowadzące do konfliktu i destrukcji", books: [], aliases: ["zemsta", "motyw zemsty", "odwet"], images: [], poems: [] },
  ]
};   
