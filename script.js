...
const data = {
  ...
  motifs: [
    ...
    { id: "motywkariery", name: "Motyw Kariery", description: "Dążenie do sukcesu społecznego i zawodowego", books: ["lalka"], aliases: ["kariera", "motyw kariery", "awans społeczny", "awans spoleczny"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywkobiety", name: "Motyw Kobiety", description: "Różnorodne role kobiet i społeczne wyobrażenia o kobiecości", books: ["chlopi", "lalka", "magbet"], aliases: ["kobieta", "motyw kobiety", "kobiecość", "kobiecosc"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywkonfliktu", name: "Motyw Konfliktu", description: "Starcie przeciwstawnych racji, wartości lub interesów", books: ["antygona", "tango", "przedwiosnie", "andrews", "miejsce"], aliases: ["konflikt", "motyw konfliktu", "spór", "spor"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywkonfliktupokolen", name: "Motyw Konfliktu Pokoleń", description: "Różnice światopoglądowe między młodymi a starszymi", books: ["wesele", "tango", "skapiec", "ferdydurke", "edek"], aliases: ["konflikt pokoleń", "konflikt pokolen", "motyw konfliktu pokoleń", "motyw konfliktu pokolen"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmarzycielstwa", name: "Motyw Marzycielstwa", description: "Ucieczka w świat wyobrażeń i idealistycznych wizji", books: [], aliases: ["marzycielstwo", "motyw marzycielstwa", "marzenia"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmatki", name: "Motyw Matki", description: "Miłość macierzyńska, troska i poświęcenie dla dziecka", books: [], aliases: ["matka", "motyw matki", "macierzyństwo", "macierzynstwo"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmilosci", name: "Motyw Miłości", description: "Uczucie jako źródło szczęścia, cierpienia lub przemiany bohatera", books: ["chlopi", "zbrodniaikara", "1984", "skapiec", "lalka", "potop"], aliases: ["miłość", "milosc", "motyw miłości", "motyw milosci"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmiasta", name: "Motyw Miasta", description: "Miasto jako przestrzeń rozwoju, anonimowości i zepsucia", books: ["zbrodniaikara", "andrews"], aliases: ["miasto", "motyw miasta", "metropolia"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmieszczanstwa", name: "Motyw Mieszczaństwa", description: "Obraz klasy średniej oraz jej aspiracji i ograniczeń", books: ["skapiec", "lalka"], aliases: ["mieszczaństwo", "mieszczanstwo", "motyw mieszczaństwa", "motyw mieszczanstwa"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywmogily", name: "Motyw Mogiły", description: "Pamięć o zmarłych i narodowa tradycja pamięci", books: [], aliases: ["mogiła", "mogila", "motyw mogiły", "motyw mogily"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywobyczajowitradycji", name: "Motyw Obyczajów i Tradycji", description: "Znaczenie norm społecznych i kulturowego dziedzictwa", books: ["tango"], aliases: ["obyczaje", "tradycja", "motyw obyczajów i tradycji", "motyw obyczajow i tradycji"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywojca", name: "Motyw Ojca", description: "Autorytet rodzicielski i relacje ojca z dzieckiem", books: ["chlopi", "przedwiosnie"], aliases: ["ojciec", "motyw ojca", "ojcostwo"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpatriotyzmu", name: "Motyw Patriotyzmu", description: "Miłość do ojczyzny i gotowość do poświęceń dla narodu", books: ["wesele", "potop", "przedwiosnie", "iliada"], aliases: ["patriotyzm", "motyw patriotyzmu", "ojczyzna"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpieniadza", name: "Motyw Pieniądza", description: "Wpływ majątku na relacje międzyludzkie i moralność", books: ["skapiec"], aliases: ["pieniądz", "pieniadz", "motyw pieniądza", "motyw pieniadza"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywposwiecenia", name: "Motyw Poświęcenia", description: "Rezygnacja z własnego dobra dla wyższych wartości", books: ["antygona", "zbrodniaikara", "innyswiat", "getto", "dzuma"], aliases: ["poświęcenie", "poswiecenie", "motyw poświęcenia", "motyw poswiecenia"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpodrozywedrowki", name: "Motyw Podróży/Wędrówki", description: "Poszukiwanie sensu życia i dojrzewanie bohatera", books: ["andrews"], aliases: ["podróż", "podroz", "wędrówka", "wedrowka", "motyw podróży"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpoezjiipoety", name: "Motyw Poezji i Poety", description: "Rola poety i znaczenie twórczości w społeczeństwie", books: [], aliases: ["poeta", "poezja", "motyw poezji i poety", "motyw poety"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpojedynku", name: "Motyw Pojedynku", description: "Honorowe rozstrzyganie konfliktów i walka o godność", books: [], aliases: ["pojedynek", "motyw pojedynku", "walka honorowa"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpolskiipolakow", name: "Motyw Polski i Polaków", description: "Refleksja nad tożsamością narodową i kondycją społeczeństwa", books: ["wesele", "tango", "edek"], aliases: ["polska", "polacy", "motyw polski i polaków", "motyw polski i polakow"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpowstania", name: "Motyw Powstania", description: "Walka narodowowyzwoleńcza i jej konsekwencje", books: ["getto"], aliases: ["powstanie", "motyw powstania", "walka narodowowyzwoleńcza"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywpracy", name: "Motyw Pracy", description: "Praca jako wartość budująca człowieka i społeczeństwo", books: ["chlopi", "lalka"], aliases: ["praca", "motyw pracy", "wysiłek", "wysilek"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywprzemiany", name: "Motyw Przemiany", description: "Wewnętrzna metamorfoza bohatera pod wpływem doświadczeń", books: ["zbrodniaikara", "potop", "przedwiosnie", "ferdydurke", "gaz"], aliases: ["przemiana", "motyw przemiany", "metamorfoza"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywprzemijania", name: "Motyw Przemijania", description: "Ulotność życia i nieuchronność upływu czasu", books: ["lalka", "polikarp"], aliases: ["przemijanie", "motyw przemijania", "upływ czasu", "uplyw czasu"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywprzepowiedni", name: "Motyw Przepowiedni", description: "Zapowiedź przyszłych wydarzeń wpływająca na los bohatera", books: ["magbet"], aliases: ["przepowiednia", "motyw przepowiedni", "proroctwo"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywprzyjazni", name: "Motyw Przyjaźni", description: "Więź oparta na lojalności, wsparciu i zaufaniu", books: ["dzuma"], aliases: ["przyjaźń", "przyjazn", "motyw przyjaźni", "motyw przyjazni"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywprzyrodynatury", name: "Motyw Przyrody/Natury", description: "Natura jako odbicie emocji i harmonii świata", books: ["chlopi"], aliases: ["przyroda", "natura", "motyw przyrody", "motyw natury"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywrewolucji", name: "Motyw Rewolucji", description: "Gwałtowne przemiany społeczne i polityczne", books: ["przedwiosnie"], aliases: ["rewolucja", "motyw rewolucji", "przewrót", "przewrot"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywrodziny", name: "Motyw Rodziny", description: "Relacje rodzinne jako źródło wsparcia lub konfliktów", books: ["chlopi", "tango", "skapiec"], aliases: ["rodzina", "motyw rodziny", "więzi rodzinne", "wiezi rodzinne"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywrusyfikacji", name: "Motyw Rusyfikacji", description: "Wynaradawianie społeczeństwa pod wpływem zaborcy rosyjskiego", books: [], aliases: ["rusyfikacja", "motyw rusyfikacji", "wynaradawianie"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywrycerza", name: "Motyw Rycerza", description: "Honor, odwaga i wierność ideałom", books: ["potop", "iliada"], aliases: ["rycerz", "motyw rycerza", "rycerskość", "rycerskosc"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywrzeki", name: "Motyw Rzeki", description: "Symbol życia, przemijania i nieustannego ruchu", books: [], aliases: ["rzeka", "motyw rzeki", "nurt rzeki"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywsamobojstwa", name: "Motyw Samobójstwa", description: "Tragiczna ucieczka od cierpienia lub konfliktu wewnętrznego", books: [], aliases: ["samobójstwo", "samobojstwo", "motyw samobójstwa", "motyw samobojstwa"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywsamotnosci", name: "Motyw Samotności", description: "Osamotnienie jednostki i wyobcowanie ze społeczeństwa", books: ["innyswiat", "gaz", "miejsce"], aliases: ["samotność", "samotnosc", "motyw samotności", "motyw samotnosci"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywsnu", name: "Motyw Snu", description: "Sen jako przestrzeń wizji, proroctwa lub podświadomości", books: [], aliases: ["sen", "motyw snu", "marzenie senne"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywspisku", name: "Motyw Spisku", description: "Tajne działania prowadzące do zmiany politycznej lub społecznej", books: ["magbet"], aliases: ["spisek", "motyw spisku", "konspiracja"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywstarosci", name: "Motyw Starości", description: "Refleksja nad przemijaniem i doświadczeniem życiowym", books: [], aliases: ["starość", "starosc", "motyw starości", "motyw starosci"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywsyna", name: "Motyw Syna", description: "Relacja syna z rodziną oraz proces dojrzewania", books: ["chlopi"], aliases: ["syn", "motyw syna", "dziecko"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywszalenstwa", name: "Motyw Szaleństwa", description: "Utrata kontroli nad rozumem i emocjami", books: ["magbet", "zbrodniaikara"], aliases: ["szaleństwo", "szalenstwo", "motyw szaleństwa", "motyw szalenstwa"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywszatana", name: "Motyw Szatana", description: "Uosobienie zła i pokusy prowadzącej do upadku", books: [], aliases: ["szatan", "motyw szatana", "diabeł", "diabel"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywszczesciaarkadii", name: "Motyw Szczęścia/Arkadii", description: "Wizja idealnego świata pełnego harmonii i spokoju", books: [], aliases: ["arkadia", "szczęście", "szczescie", "motyw arkadii"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywszkoly", name: "Motyw Szkoły", description: "Edukacja jako narzędzie rozwoju lub zniewolenia", books: ["ferdydurke"], aliases: ["szkoła", "szkola", "motyw szkoły", "motyw szkoly"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywszlachty", name: "Motyw Szlachty", description: "Obraz warstwy szlacheckiej i jej tradycji", books: ["ferdydurke"], aliases: ["szlachta", "motyw szlachty", "szlachcic"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywtanca", name: "Motyw Tańca", description: "Taniec jako symbol relacji społecznych lub emocji zbiorowych", books: ["wesele", "chlopi"], aliases: ["taniec", "motyw tańca", "motyw tanca"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywtotalitaryzmu", name: "Motyw Totalitaryzmu", description: "Zniewolenie jednostki przez system polityczny", books: ["innyswiat", "1984"], aliases: ["totalitaryzm", "motyw totalitaryzmu", "dyktatura"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywuczniaimistrza", name: "Motyw Ucznia i Mistrza", description: "Relacja oparta na przekazywaniu wiedzy i doświadczenia", books: ["polikarp"], aliases: ["uczeń i mistrz", "uczen i mistrz", "motyw ucznia i mistrza"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwladcy", name: "Motyw Władcy", description: "Obraz rządzącego i odpowiedzialności za państwo", books: ["antygona"], aliases: ["władca", "wladca", "motyw władcy", "motyw wladcy"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwladzy", name: "Motyw Władzy", description: "Mechanizmy sprawowania kontroli i wpływu na ludzi", books: ["antygona", "magbet", "tango", "1984", "edek"], aliases: ["władza", "wladza", "motyw władzy", "motyw wladzy"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwinyikary", name: "Motyw Winy i Kary", description: "Moralne konsekwencje popełnionych czynów", books: ["magbet", "zbrodniaikara"], aliases: ["wina i kara", "motyw winy i kary", "kara", "wina"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwojny", name: "Motyw Wojny", description: "Tragizm konfliktów zbrojnych i ich wpływ na człowieka", books: ["potop", "gaz", "getto", "iliada"], aliases: ["wojna", "motyw wojny", "konflikt zbrojny"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwolnosci", name: "Motyw Wolności", description: "Dążenie jednostki lub narodu do niezależności", books: ["innyswiat", "1984"], aliases: ["wolność", "wolnosc", "motyw wolności", "motyw wolnosci"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywwsi", name: "Motyw Wsi", description: "Idealizacja lub krytyka życia wiejskiego i chłopstwa", books: ["wesele", "chlopi"], aliases: ["wieś", "wies", "motyw wsi", "życie na wsi"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywzla", name: "Motyw Zła", description: "Obecność destrukcyjnych sił w świecie i człowieku", books: ["magbet", "innyswiat", "gaz"], aliases: ["zło", "zlo", "motyw zła", "motyw zla"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywzbrodni", name: "Motyw Zbrodni", description: "Przekroczenie norm moralnych i jego konsekwencje", books: ["magbet", "zbrodniaikara", "gaz"], aliases: ["zbrodnia", "motyw zbrodni", "przestępstwo", "przestepstwo"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywzdrady", name: "Motyw Zdrady", description: "Złamanie lojalności wobec bliskich, idei lub ojczyzny", books: ["1984", "potop"], aliases: ["zdrada", "motyw zdrady", "nielojalność", "nielojalnosc"], images: [{ src: "images/motywy/" }], poems: [] },
    { id: "motywzemsty", name: "Motyw Zemsty", description: "Pragnienie odwetu prowadzące do konfliktu i destrukcji", books: ["iliada"], aliases: ["zemsta", "motyw zemsty", "odwet"], images: [{ src: "images/motywy/" }], poems: [] },
  ],
