...
books: [
  ...
  motifs: [
    { id: "motywsmierci", name: "Motyw Śmierci", description: "Nieuchronność kresu życia i refleksja nad sensem istnienia", books: ["antygona", "getto", "dzuma", "iliada", "polikarp"], aliases: ["śmierć", "smierc", "motyw śmierci", "motyw smierci"], images: [{ src: "images/motywy/smierc/smierc-marata-david.jpg" }], poems: [ { author: "Baczynski", title: "Pokolenie(Do palcow)", src: "images/motywy/smierc/Baczynski_Pokolenie(Do_palcow).txt" },
    { author: "Słowacki", title: "testament moj", src: "images/motywy/smierc/Słowacki_testament_moj.txt" },
    { author: "Kochanowski", title: "tren sen", src: "images/motywy/smierc/kochanowski_tren_sen.txt" },
    { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/smierc/mickiewicz_reduta_ordona.txt" },
    { author: "Rozewicz", title: "ocalony", src: "images/motywy/smierc/rozewicz_ocalony.txt" },
    { author: "Słowacki", title: "grób agamemnona", src: "images/motywy/smierc/słowacki_grób_agamemnona.txt" },] },
    { id: "motywzyda", name: "Motyw Żyda", description: "Obraz mniejszości żydowskiej oraz problem uprzedzeń i asymilacji", books: ["getto"], aliases: ["żyd", "zyd", "motyw żyda", "motyw zyda"], images: [{ src: "images/motywy//zyda/images (2).jpg" }], poems: [ { author: "", title: "milosz-biedny-chrzescijanin-patrzy-na-getto", src: "images/motywy/zyda/milosz-biedny-chrzescijanin-patrzy-na-getto.txt" },] },
    { id: "motywartysty", name: "Motyw Artysty", description: "Wyjątkowość twórcy i konflikt między sztuką a społeczeństwem", books: ["wesele"], aliases: ["artysta", "motyw artysty", "twórca", "tworca"], images: [{ src: "images/motywy/artysta/panny_dworskie-jpg.jpg" }], poems: [{ author: "Horacy", title: "exegi monumentum", src: "images/motywy/artysta/Horacy_exegi_monumentum.txt" },
    { author: "Przerwa Tetmajer", title: "Eviva larte", src: "images/motywy/artysta/Przerwa-Tetmajer_Eviva_larte.txt" },] },
    { id: "motywarystokracji", name: "Motyw Arystokracji", description: "Krytyka uprzywilejowanych warstw i ich oderwania od rzeczywistości", books: ["lalka"], aliases: ["arystokracja", "motyw arystokracji", "arystokraci"], images: [{ src: "images/motywy/arystokracja/Portret holenderskiego patrycjusza.jpg" }], poems: [ { author: "Szymborska", title: "miniatura średniowieczna", src: "images/motywy/arystokracja/szymborska_miniatura_średniowieczna.txt" },] },
    { id: "motywbiedy", name: "Motyw Biedy", description: "Degradacja człowieka wynikająca z ubóstwa i nierówności społecznych", books: ["zbrodniaikara", "przedwiosnie"], aliases: ["bieda", "motyw biedy", "ubóstwo", "ubostwo"], images: [{ src: "images/motywy/bieda/matula_pomarli-jpg.jpg" }], poems: [{ author: "Przerwa Tetmajer", title: "Eviva larte", src: "images/motywy/bieda/Przerwa-Tetmajer_Eviva_larte.txt" },] },
    { id: "motywboga", name: "Motyw Boga", description: "Poszukiwanie sensu życia i relacji człowieka z absolutem", books: ["potop", "getto", "dzuma", "polikarp"], aliases: ["bóg", "bog", "motyw boga"], images: [{ src: "images/motywy/bog/laskami-slynacy-obraz-boga-ojca-kielce.jpg" }], poems: [{ author: "", title: "Bogurodzica", src: "images/motywy/bog/Bogurodzica.txt" },
    { author: "Kasprowicz", title: "tam za wioska przyjm..", src: "images/motywy/bog/kasprowicz_tam_za_wioska_przyjm...txt" },
    { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/bog/mickiewicz_reduta_ordona.txt" },] },
    ...
    { id: "motywbuntu", name: "Motyw Buntu", description: "Sprzeciw wobec norm społecznych, władzy lub przeznaczenia", books: ["wesele", "antygona", "tango", "1984", "innyswiat", "przedwiosnie", "ferdydurke", "getto", "dzuma"], aliases: ["bunt", "motyw buntu", "sprzeciw"], images: [{ src: "images/motywy/bunt/Eugène_Delacroix_-_La_liberté_guidant_le_peuple.jpg" }], poems: [{ author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/bunt/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywcorki", name: "Motyw Córki", description: "Relacje rodzinne oraz emocjonalna więź dziecka z rodzicami", books: [], aliases: ["córka", "corka", "motyw córki", "motyw corki"], images: [{ src: "images/motywy/corka/Mattia_Preti_-_Lot_and_his_Daughters_ca_1675-1680_-_(MeisterDrucke-763198).jpg" }], poems: [{ author: "Kochanowski", title: "trenX", src: "images/motywy/corka/Kochanowski_trenX.txt" },] },
    { id: "motywcierpienia", name: "Motyw Cierpienia", description: "Ból fizyczny lub psychiczny jako doświadczenie kształtujące człowieka", books: ["innyswiat", "gaz", "dzuma"], aliases: ["cierpienie", "motyw cierpienia", "ból", "bol"], images: [{ src: "images/motywy/cierpienie/hieronim_bosch_sad_ostateczny-jpg.jpg" }], poems: [ { author: "Kochanowski", title: "piesnV", src: "images/motywy/cierpienie/Kochanowski_piesnV.txt" },
    { author: "Kochanowski", title: "trenX", src: "images/motywy/cierpienie/Kochanowski_trenX.txt" },
    { author: "Kochanowski", title: "tren sen", src: "images/motywy/cierpienie/kochanowski_tren_sen.txt" },] },
    { id: "motywdomu", name: "Motyw Domu", description: "Dom jako symbol bezpieczeństwa, tradycji i tożsamości", books: ["ferdydurke"], aliases: ["dom", "motyw domu", "ognisko domowe"], images: [{ src: "images/motywy/dom/ferdynand_ruszyc_stary_dom-jpg.jpg" }], poems: [ { author: "Kochanowski", title: "na dom w czarnolesie", src: "images/motywy/dom/kochanowski_na_dom_w_czarnolesie.txt" },] },
    { id: "motywdworku", name: "Motyw Dworku", description: "Idealizacja życia szlacheckiego i przywiązania do tradycji", books: ["ferdydurke"], aliases: ["dworek", "motyw dworku", "dwór", "dwor"], images: [{ src: "images/motywy/dworek/jozef_szermentowski_poddanstwo-jpg.jpg" }], poems: [ { author: "Mickiewicz", title: "Pan Tadeusz fragment", src: "images/motywy/dworek/Mickiewicz_Pan_Tadeusz_fragment.txt" },] },
    { id: "motywdziecka", name: "Motyw Dziecka", description: "Niewinność, wrażliwość i dojrzewanie młodego człowieka", books: [], aliases: ["dziecko", "motyw dziecka", "dzieciństwo", "dziecinstwo"], images: [{ src: "images/motywy/dziecko/jan_matejko__dzieci-jpg.jpg" }], poems: [ { author: "Kochanowski", title: "tren sen", src: "images/motywy/dziecko/kochanowski_tren_sen.txt" },] },
    { id: "motywfatumprzeznaczenia", name: "Motyw Fatum/Przeznaczenia", description: "Nieuchronność losu determinującego życie bohatera", books: ["antygona", "magbet", "iliada"], aliases: ["fatum", "przeznaczenie", "motyw fatum", "motyw przeznaczenia"], images: [{ src: "images/motywy/fatum/Francisco_de_Goya,_Saturno_devorando_a_su_hijo_(1819-1823).jpg" }], poems: [{ author: "Norwid", title: "Fatum", src: "images/motywy/fatum/Norwid_Fatum.txt" },] },
    { id: "motywfilantropii", name: "Motyw Filantropii", description: "Bezinteresowna pomoc innym jako wyraz humanizmu", books: ["lalka"], aliases: ["filantropia", "motyw filantropii", "pomoc innym"], images: [{ src: "images/motywy/filantropia/filantropia.jpg" }], poems: [{ author: "Milosz", title: "Campo di fiori", src: "images/motywy/filantropia/Milosz_Campo_di_fiori.txt" },] },
    { id: "motywkariery", name: "Motyw Kariery", description: "Dążenie do sukcesu społecznego i zawodowego", books: ["lalka"], aliases: ["kariera", "motyw kariery", "awans społeczny", "awans spoleczny"], images: [{ src: "images/motywy/kariera/Courbet_-_Kamieniarze.jpg" }], poems: [{ author: "Szymborska", title: "Pisanie zyciorusu", src: "images/motywy/kariera/Szymborska_Pisanie_zyciorusu.txt" },] },
    { id: "motywkobiety", name: "Motyw Kobiety", description: "Różnorodne role kobiet i społeczne wyobrażenia o kobiecości", books: ["chlopi", "lalka", "magbet"], aliases: ["kobieta", "motyw kobiety", "kobiecość", "kobiecosc"], images: [{ src: "images/motywy/kobieta/monalisa.jpg" }], poems: [{ author: "Szymborska", title: "portret kobiety", src: "images/motywy/kobieta/szymborska_portret_kobiety.txt" },] },
    { id: "motywkonfliktu", name: "Motyw Konfliktu", description: "Starcie przeciwstawnych racji, wartości lub interesów", books: ["antygona", "tango", "przedwiosnie", "andrews", "miejsce"], aliases: ["konflikt", "motyw konfliktu", "spór", "spor"], images: [{ src: "images/motywy/konflikt/jan-moniuszko-pojedynek-w-karczmie-mnw.jpg" }], poems: [{ author: "Herbert", title: "O dwu nogach pan cogito", src: "images/motywy/konflikt/Herbert_O_dwu_nogach_pan_cogito.txt" },
    { author: "Lesmian", title: "tu jestem", src: "images/motywy/konflikt/lesmian_tu_jestem.txt" },] },
    { id: "motywkonfliktupokolen", name: "Motyw Konfliktu Pokoleń", description: "Różnice światopoglądowe między młodymi a starszymi", books: ["wesele", "tango", "skapiec", "ferdydurke", "edek"], aliases: ["konflikt pokoleń", "konflikt pokolen", "motyw konfliktu pokoleń", "motyw konfliktu pokolen"], images: [{ src: "images/motywy/konflikt_pokolen/rembrandt_van_rijn_powrot_syna_marnotrawnego-jpg.jpg" }], poems: [{ author: "Asnyk", title: "do mlodych", src: "images/motywy/konflikt_pokolen/asnyk_do_mlodych.txt" },] },
    { id: "motywmarzycielstwa", name: "Motyw Marzycielstwa", description: "Ucieczka w świat wyobrażeń i idealistycznych wizji", books: [], aliases: ["marzycielstwo", "motyw marzycielstwa", "marzenia"], images: [{ src: "images/motywy/marzycielstwo/53796_1_zoom.jpg" }], poems: [{ author: "Herbert", title: "O dwu nogach pan cogito", src: "images/motywy/marzycielstwo/Herbert_O_dwu_nogach_pan_cogito.txt" },] },
    { id: "motywmatki", name: "Motyw Matki", description: "Miłość macierzyńska, troska i poświęcenie dla dziecka", books: [], aliases: ["matka", "motyw matki", "macierzyństwo", "macierzynstwo"], images: [{ src: "images/motywy/matka/Whistler-matka-whistlera.jpg" }], poems: [{ author: "", title: "Bogurodzica", src: "images/motywy/matka/Bogurodzica.txt" },] },
    { id: "motywmilosci", name: "Motyw Miłości", description: "Uczucie jako źródło szczęścia, cierpienia lub przemiany bohatera", books: ["chlopi", "zbrodniaikara", "1984", "skapiec", "lalka", "potop"], aliases: ["miłość", "milosc", "motyw miłości", "motyw milosci"], images: [{ src: "images/motywy/milosc/Edmund-Leighton-Tristan_and_Isolde-1902.jpg" }], poems: [{ author: "Mickiewicz", title: "romantycznosc", src: "images/motywy/milosc/mickiewicz_romantycznosc.txt" },] },
    { id: "motywmiasta", name: "Motyw Miasta", description: "Miasto jako przestrzeń rozwoju, anonimowości i zepsucia", books: ["zbrodniaikara", "andrews"], aliases: ["miasto", "motyw miasta", "metropolia"], images: [{ src: "images/motywy/miasto/bernardo_bellotto_widok_na_warszawe-jpg.jpg" }], poems: [{ author: "Baczynski", title: "oddycha miasto ciemne dlugimi wiekami", src: "images/motywy/miasto/baczynski_oddycha_miasto_ciemne_dlugimi_wiekami.txt" },
    { author: "Milosz", title: "campo di fiori", src: "images/motywy/miasto/milosz_campo_di_fiori.txt" },] },
    { id: "motywmieszczanstwa", name: "Motyw Mieszczaństwa", description: "Obraz klasy średniej oraz jej aspiracji i ograniczeń", books: ["skapiec", "lalka"], aliases: ["mieszczaństwo", "mieszczanstwo", "motyw mieszczaństwa", "motyw mieszczanstwa"], images: [{ src: "images/motywy/mieszczanstwo/0.0.IMG_3947.jpg" }], poems: [{ author: "Milosz", title: "campo di fiori", src: "images/motywy/mieszczanstwo/milosz_campo_di_fiori.txt" },] },
    { id: "motywmogily", name: "Motyw Mogiły", description: "Pamięć o zmarłych i narodowa tradycja pamięci", books: [], aliases: ["mogiła", "mogila", "motyw mogiły", "motyw mogily"], images: [{ src: "images/motywy/mogila/unnamed.jpg" }], poems: [{ author: "Słowacki", title: "grób agamemnona", src: "images/motywy/mogila/słowacki_grób_agamemnona.txt" },] },
    { id: "motywobyczajowitradycji", name: "Motyw Obyczajów i Tradycji", description: "Znaczenie norm społecznych i kulturowego dziedzictwa", books: ["tango"], aliases: ["obyczaje", "tradycja", "motyw obyczajów i tradycji", "motyw obyczajow i tradycji"], images: [{ src: "images/motywy/obyczaje_tradycja/8._Lithuanian_Girl.jpg" }], poems: [{ author: "Kochanowski", title: "na dom w czarnolesie", src: "images/motywy/obyczaje_tradycja/kochanowski_na_dom_w_czarnolesie.txt" },] },
    { id: "motywojca", name: "Motyw Ojca", description: "Autorytet rodzicielski i relacje ojca z dzieckiem", books: ["chlopi", "przedwiosnie"], aliases: ["ojciec", "motyw ojca", "ojcostwo"], images: [{ src: "images/motywy/ojciec/2662.jpg" }], poems: [{ author: "Kasprowicz", title: "tam za wioska przyjm..", src: "images/motywy/ojciec/kasprowicz_tam_za_wioska_przyjm...txt" },] },
    { id: "motywpatriotyzmu", name: "Motyw Patriotyzmu", description: "Miłość do ojczyzny i gotowość do poświęceń dla narodu", books: ["wesele", "potop", "przedwiosnie", "iliada"], aliases: ["patriotyzm", "motyw patriotyzmu", "ojczyzna"], images: [{ src: "images/motywy/patriotyzm/jacek-malczewski-melancholia-palac-rogalin.jpg" }], poems: [{ author: "Słowacki", title: "testament moj", src: "images/motywy/patriotyzm/Słowacki_testament_moj.txt" },
    { author: "Krasicki", title: "hymn do milosci ojczyzny", src: "images/motywy/patriotyzm/krasicki_hymn_do_milosci_ojczyzny.txt" },
    { author: "Słowacki", title: "grób agamemnona", src: "images/motywy/patriotyzm/słowacki_grób_agamemnona.txt" },] },
    { id: "motywpieniadza", name: "Motyw Pieniądza", description: "Wpływ majątku na relacje międzyludzkie i moralność", books: ["skapiec"], aliases: ["pieniądz", "pieniadz", "motyw pieniądza", "motyw pieniadza"], images: [{ src: "images/motywy/pieniedzy/pieniadz4.jpg" }], poems: [{ author: "Krasicki", title: "Do krola", src: "images/motywy/pieniedzy/Krasicki_Do_krola.txt" },] },
    ...
    { id: "motywpodrozywedrowki", name: "Motyw Podróży/Wędrówki", description: "Poszukiwanie sensu życia i dojrzewanie bohatera", books: ["andrews"], aliases: ["podróż", "podroz", "wędrówka", "wedrowka", "motyw podróży"], images: [{ src: "images/motywy/podroz_wedrowka/Caspar-David-Friedrich_Wedrowiec-nad-morzem-mgly_ok.-1817-315x400.jpg" }], poems: [{ author: "Mickiewicz", title: "żegluga", src: "images/motywy/podroz_wedrowka/mickiewicz_żegluga.txt" },] },
    { id: "motywpoezjiipoety", name: "Motyw Poezji i Poety", description: "Rola poety i znaczenie twórczości w społeczeństwie", books: [], aliases: ["poeta", "poezja", "motyw poezji i poety", "motyw poety"], images: [{ src: "images/motywy/pozeja_poeta/nicolas_poussin_natchnienie_poety-jpg.jpg" }], poems: [{ author: "Słowacki", title: "testament moj", src: "images/motywy/poezja_poeta/Słowacki_testament_moj.txt" },
    { author: "Słowacki", title: "grób agamemnona", src: "images/motywy/poezja_poeta/słowacki_grób_agamemnona.txt" },] },
    { id: "motywpojedynku", name: "Motyw Pojedynku", description: "Honorowe rozstrzyganie konfliktów i walka o godność", books: [], aliases: ["pojedynek", "motyw pojedynku", "walka honorowa"], images: [{ src: "images/motywy/pojedynek/pojedynek-mnw.jpg" }], poems: [{ author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/pojedynek/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywpolskiipolakow", name: "Motyw Polski i Polaków", description: "Refleksja nad tożsamością narodową i kondycją społeczeństwa", books: ["wesele", "tango", "edek"], aliases: ["polska", "polacy", "motyw polski i polaków", "motyw polski i polakow"], images: [{ src: "images/motywy/polska_polacy/Jan_Matejko_-_Upadek_Polski_(Reytan).jpg" }], poems: [ { author: "Kochanowski", title: "piesnV", src: "images/motywy/polska_polacy/Kochanowski_piesnV.txt" },
    { author: "Krasicki", title: "Do krola", src: "images/motywy/polska_polacy/Krasicki_Do_krola.txt" },
    { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/polska_polacy/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywpowstania", name: "Motyw Powstania", description: "Walka narodowowyzwoleńcza i jej konsekwencje", books: ["getto"], aliases: ["powstanie", "motyw powstania", "walka narodowowyzwoleńcza"], images: [{ src: "images/motywy/powstanie/artur-grottger_pozar-dworu-pod-miechowem_3020_tile.jpg" }], poems: [{ author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/powstanie/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywpracy", name: "Motyw Pracy", description: "Praca jako wartość budująca człowieka i społeczeństwo", books: ["chlopi", "lalka"], aliases: ["praca", "motyw pracy", "wysiłek", "wysilek"], images: [{ src: "images/motywy/praca/images.jpg" }], poems: [ { author: "Stwaff", title: "kowal", src: "images/motywy/praca/Stwaff_kowal.txt" },] },
    { id: "motywprzemiany", name: "Motyw Przemiany", description: "Wewnętrzna metamorfoza bohatera pod wpływem doświadczeń", books: ["zbrodniaikara", "potop", "przedwiosnie", "ferdydurke", "gaz"], aliases: ["przemiana", "motyw przemiany", "metamorfoza"], images: [{ src: "images/motywy/przemiana/60fad2ea3263a.jpg" }], poems: [{ author: "Kochanowski", title: "tren sen", src: "images/motywy/przemiana/kochanowski_tren_sen.txt" },] },
    { id: "motywprzemijania", name: "Motyw Przemijania", description: "Ulotność życia i nieuchronność upływu czasu", books: ["lalka", "polikarp"], aliases: ["przemijanie", "motyw przemijania", "upływ czasu", "uplyw czasu"], images: [{ src: "images/motywy/przemijanie/250px-Pieter_Claeszoon-_Vanitas_-_Still_Life_(1625,_29,5_x_34,5_cm).jpg" }], poems: [{ author: "Horacy", title: "exegi monumentum", src: "images/motywy/przemijanie/Horacy_exegi_monumentum.txt" },] },
    { id: "motywprzepowiedni", name: "Motyw Przepowiedni", description: "Zapowiedź przyszłych wydarzeń wpływająca na los bohatera", books: ["magbet"], aliases: ["przepowiednia", "motyw przepowiedni", "proroctwo"], images: [{ src: "images/motywy/przepowiednia/Vittore_Carpaccio_-_The_Prediction_of_St_Stephen_in_Jerusalem_Painting_part_of_a_series_executed_for_-_(MeisterDrucke-998982).jpg" }], poems: [{ author: "Konopnicka(O", title: "wy co cierpiec umiecie w pokorze)", src: "images/motywy/przepowiednia/Konopnicka(O_wy_co_cierpiec_umiecie_w_pokorze).txt" },] },
    { id: "motywprzyjazni", name: "Motyw Przyjaźni", description: "Więź oparta na lojalności, wsparciu i zaufaniu", books: ["dzuma"], aliases: ["przyjaźń", "przyjazn", "motyw przyjaźni", "motyw przyjazni"], images: [{ src: "images/motywy/przyjazn/Breslau_-_Friends.jpg" }], poems: [{ author: "Mickiewicz", title: "Oda do mlodosci", src: "images/motywy/przyjazn/Mickiewicz_Oda_do_mlodosci.txt" },] },
    { id: "motywprzyrodynatury", name: "Motyw Przyrody/Natury", description: "Natura jako odbicie emocji i harmonii świata", books: ["chlopi"], aliases: ["przyroda", "natura", "motyw przyrody", "motyw natury"], images: [{ src: "images/motywy/przyroda_natura/henri_rousseau_tygrys_podczas_burzy_tropikalnej-jpg.jpg" }], poems: [{ author: "Mickiewicz", title: "stepy akermańskie", src: "images/motywy/przyroda_natura/mickiewicz_stepy_akermańskie.txt" },] },
    { id: "motywrewolucji", name: "Motyw Rewolucji", description: "Gwałtowne przemiany społeczne i polityczne", books: ["przedwiosnie"], aliases: ["rewolucja", "motyw rewolucji", "przewrót", "przewrot"], images: [{ src: "images/motywy/rewolucja/La_Liberté_guidant_le_peuple_-_Eugène_Delacroix_-_Musée_du_Louvre_Peintures_RF_129_-_après_restauration_2024.jpg" }], poems: [ { author: "Mickiewicz", title: "Oda do mlodosci", src: "images/motywy/rewolucja/Mickiewicz_Oda_do_mlodosci.txt" },] },
    { id: "motywrodziny", name: "Motyw Rodziny", description: "Relacje rodzinne jako źródło wsparcia lub konfliktów", books: ["chlopi", "tango", "skapiec"], aliases: ["rodzina", "motyw rodziny", "więzi rodzinne", "wiezi rodzinne"], images: [{ src: "images/motywy/rodzina/Jan_Matejko_-_Portret_trojga_dzieci_artysty.jpg" }], poems: [{ author: "Mickiewicz", title: "TrenVIII", src: "images/motywy/rodzina/Mickiewicz_TrenVIII.txt" },] },
    { id: "motywrusyfikacji", name: "Motyw Rusyfikacji", description: "Wynaradawianie społeczeństwa pod wpływem zaborcy rosyjskiego", books: [], aliases: ["rusyfikacja", "motyw rusyfikacji", "wynaradawianie"], images: [{ src: "images/motywy/rusyfikacja/Edvard_Isto.jpg" }], poems: [{ author: "Lechon", title: "herostrates", src: "images/motywy/rusyfikacja/Lechon_herostrates.txt" },] },
    { id: "motywrycerza", name: "Motyw Rycerza", description: "Honor, odwaga i wierność ideałom", books: ["potop", "iliada"], aliases: ["rycerz", "motyw rycerza", "rycerskość", "rycerskosc"], images: [{ src: "images/motywy/rycerz/images (1).jpg" }], poems: [{ author: "Konopnicka", title: "Na grobie rycerz", src: "images/motywy/rycerz/Konopnicka_Na_grobie_rycerz.txt" },
    { author: "Szymborska", title: "miniatura średniowieczna", src: "images/motywy/rycerz/szymborska_miniatura_średniowieczna.txt" },] },
    { id: "motywrzeki", name: "Motyw Rzeki", description: "Symbol życia, przemijania i nieustannego ruchu", books: [], aliases: ["rzeka", "motyw rzeki", "nurt rzeki"], images: [{ src: "images/motywy/rzeka/D-Gromacki_Rzeki-Puszczy-Bialowieskiej-Braszcza_90x60_olej-na-plotnie_2024-scaled.jpg" }], poems: [{ author: "Baczynski", title: "Pokolenie(Do palcow)", src: "images/motywy/rzeka/Baczynski_Pokolenie(Do_palcow).txt" },] },
    { id: "motywsamobojstwa", name: "Motyw Samobójstwa", description: "Tragiczna ucieczka od cierpienia lub konfliktu wewnętrznego", books: [], aliases: ["samobójstwo", "samobojstwo", "motyw samobójstwa", "motyw samobojstwa"], images: [{ src: "images/motywy/samobojstwo/1040px-edouard_manet_-_le_suicide-1024x886.jpg" }], poems: [{ author: "Tetmajer", title: "Koniec wiekuXIX", src: "images/motywy/samobojstwo/Tetmajer_Koniec_wiekuXIX.txt" },] },
    { id: "motywsamotnosci", name: "Motyw Samotności", description: "Osamotnienie jednostki i wyobcowanie ze społeczeństwa", books: ["innyswiat", "gaz", "miejsce"], aliases: ["samotność", "samotnosc", "motyw samotności", "motyw samotnosci"], images: [{ src: "images/motywy/samotnosc/Van_Gogh_Trauernder_alter_Mann.jpg" }], poems: [{ author: "Mickiewicz", title: "cisza morska", src: "images/motywy/samotnosc/mickiewicz_cisza_morska.txt" },] },
    { id: "motywsnu", name: "Motyw Snu", description: "Sen jako przestrzeń wizji, proroctwa lub podświadomości", books: [], aliases: ["sen", "motyw snu", "marzenie senne"], images: [{ src: "images/motywy/sen/fussli-nocna-mara-detroit.jpg" }], poems: [{ author: "Kochanowski", title: "tren sen", src: "images/motywy/sen/kochanowski_tren_sen.txt" },] },
    { id: "motywspisku", name: "Motyw Spisku", description: "Tajne działania prowadzące do zmiany politycznej lub społecznej", books: ["magbet"], aliases: ["spisek", "motyw spisku", "konspiracja"], images: [{ src: "images/motywy/spisek/Durer_chrystus.jpg" }], poems: [{ author: "Tuwim", title: "Do prostych ludzi", src: "images/motywy/spisek/Tuwim_Do_prostych_ludzi.txt" },] },
    { id: "motywstarosci", name: "Motyw Starości", description: "Refleksja nad przemijaniem i doświadczeniem życiowym", books: [], aliases: ["starość", "starosc", "motyw starości", "motyw starosci"], images: [{ src: "images/motywy/starosc/2bBWO6g7dXBUn0Gkpd63LWb4HW9cL6x4.jpg" }], poems: [{ author: "Kochanowski", title: "na dom w czarnolesie", src: "images/motywy/starosc/kochanowski_na_dom_w_czarnolesie.txt" },
    { author: "Mickiewicz", title: "oda do mlodosci", src: "images/motywy/starosc/mickiewicz_oda_do_mlodosci.txt" },] },
    { id: "motywsyna", name: "Motyw Syna", description: "Relacja syna z rodziną oraz proces dojrzewania", books: ["chlopi"], aliases: ["syn", "motyw syna", "dziecko"], images: [{ src: "images/motywy/syn/Ritorno_del_figliol_prodigo_Guercino_ante_1617_Galleria_Sabauda.jpg" }], poems: [ { author: "", title: "Bogurodzica", src: "images/motywy/syn/Bogurodzica.txt" },
    { author: "Słowacki", title: "grób agamemnona", src: "images/motywy/syn/słowacki_grób_agamemnona.txt" },] },
    { id: "motywszalenstwa", name: "Motyw Szaleństwa", description: "Utrata kontroli nad rozumem i emocjami", books: ["magbet", "zbrodniaikara"], aliases: ["szaleństwo", "szalenstwo", "motyw szaleństwa", "motyw szalenstwa"], images: [{ src: "images/motywy/szaleństwo/Van_Gogh_-_Selbstbildnis_mit_verbundenem_Ohr.jpeg" }], poems: [{ author: "Mickiewicz", title: "romantycznosc", src: "images/motywy/szaleństwo/mickiewicz_romantycznosc.txt" },] },
    { id: "motywszatana", name: "Motyw Szatana", description: "Uosobienie zła i pokusy prowadzącej do upadku", books: [], aliases: ["szatan", "motyw szatana", "diabeł", "diabel"], images: [{ src: "images/motywy/szatan/diabel26.jpg" }], poems: [{ author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/szatan/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywszczesciaarkadii", name: "Motyw Szczęścia/Arkadii", description: "Wizja idealnego świata pełnego harmonii i spokoju", books: [], aliases: ["arkadia", "szczęście", "szczescie", "motyw arkadii"], images: [{ src: "images/motywy/szczescie_arkadia/z16280579IER,-Ogrod-rozkoszy-ziemskich--Hieronima-Boscha.jpg" }], poems: [ { author: "Karpinski", title: "Laura i Filon", src: "images/motywy/szczescie_arkadia/Karpinski_Laura_i_Filon.txt" },] },
    { id: "motywszkoly", name: "Motyw Szkoły", description: "Edukacja jako narzędzie rozwoju lub zniewolenia", books: ["ferdydurke"], aliases: ["szkoła", "szkola", "motyw szkoły", "motyw szkoly"], images: [{ src: "images/motywy/szkola/henri_toulouse-lautrec-jpg.jpg" }], poems: [{ author: "Kaczmarski", title: "Zesłanie studentow", src: "images/motywy/szkola/Kaczmarski_Zesłanie_studentow.txt" },] },
    { id: "motywszlachty", name: "Motyw Szlachty", description: "Obraz warstwy szlacheckiej i jej tradycji", books: ["ferdydurke"], aliases: ["szlachta", "motyw szlachty", "szlachcic"], images: [{ src: "images/motywy/szlachta/m gierymski zajazd na soplicowo.jpg" }], poems: [{ author: "Krasicki", title: "Do krola", src: "images/motywy/szlachta/Krasicki_Do_krola.txt" },] },
    { id: "motywtanca", name: "Motyw Tańca", description: "Taniec jako symbol relacji społecznych lub emocji zbiorowych", books: ["wesele", "chlopi"], aliases: ["taniec", "motyw tańca", "motyw tanca"], images: [{ src: "images/motywy/taniec/danse-macabre-bernardyni-3-892x1200.jpg" }], poems: [{ author: "Kochanowski", title: "piesn-swietojanska-o-sobotce", src: "images/motywy/taniec/Kochanowski_piesn-swietojanska-o-sobotce.txt" },] },
    { id: "motywtotalitaryzmu", name: "Motyw Totalitaryzmu", description: "Zniewolenie jednostki przez system polityczny", books: ["innyswiat", "1984"], aliases: ["totalitaryzm", "motyw totalitaryzmu", "dyktatura"], images: [{ src: "images/motywy/totalitaryzm/Guernica_reproduction_on_tiled_wall,_Guernica,_Spain_(PPL3-Altered)_julesvernex2.jpg" }], poems: [{ author: "Herbert", title: "potega smaku", src: "images/motywy/totalitaryzm/Herbert_potega_smaku.txt" },] },
    { id: "motywuczniaimistrza", name: "Motyw Ucznia i Mistrza", description: "Relacja oparta na przekazywaniu wiedzy i doświadczenia", books: ["polikarp"], aliases: ["uczeń i mistrz", "uczen i mistrz", "motyw ucznia i mistrza"], images: [{ src: "images/motywy/uczen_mistrz/artur_grottger_szkola_szlachcica_polskiego-jpg.jpg" }], poems: [ { author: "Rozewicz", title: "ocalony", src: "images/motywy/uczen_mistrz/rozewicz_ocalony.txt" },] },
    { id: "motywwladcy", name: "Motyw Władcy", description: "Obraz rządzącego i odpowiedzialności za państwo", books: ["antygona"], aliases: ["władca", "wladca", "motyw władcy", "motyw wladcy"], images: [{ src: "images/motywy/wladca/David-Bonaparte.jpg" }], poems: [{ author: "Krasicki", title: "Do krola", src: "images/motywy/wladca/Krasicki_Do_krola.txt" },
    { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/wladca/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywwladzy", name: "Motyw Władzy", description: "Mechanizmy sprawowania kontroli i wpływu na ludzi", books: ["antygona", "magbet", "tango", "1984", "edek"], aliases: ["władza", "wladza", "motyw władzy", "motyw wladzy"], images: [{ src: "images/motywy/wladza/Koronacja-Napoleona-2.jpg" }], poems: [{ author: "Tuwim", title: "Do prostych ludzi", src: "images/motywy/wladza/Tuwim_Do_prostych_ludzi.txt" },] },
    { id: "motywwinyikary", name: "Motyw Winy i Kary", description: "Moralne konsekwencje popełnionych czynów", books: ["magbet", "zbrodniaikara"], aliases: ["wina i kara", "motyw winy i kary", "kara", "wina"], images: [{ src: "images/motywy/wina_kara/benjamin_west_wenus_oplakujaca_adonisa-jpg.jpg" }], poems: [ { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/wina_kara/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywwojny", name: "Motyw Wojny", description: "Tragizm konfliktów zbrojnych i ich wpływ na człowieka", books: ["potop", "gaz", "getto", "iliada"], aliases: ["wojna", "motyw wojny", "konflikt zbrojny"], images: [{ src: "images/motywy/wojna/francisco_goya_kolos-jpg.jpg" }], poems: [ { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/wojna/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywwolnosci", name: "Motyw Wolności", description: "Dążenie jednostki lub narodu do niezależności", books: ["innyswiat", "1984"], aliases: ["wolność", "wolnosc", "motyw wolności", "motyw wolnosci"], images: [{ src: "images/motywy/wolnosc/eugene-delacroix-wolnosc-wiodaca-na-barykady.jpg" }], poems: [{ author: "Mickiewicz", title: "Oda do mlodosci", src: "images/motywy/wolnosc/Mickiewicz_Oda_do_mlodosci.txt" },] },
    { id: "motywwsi", name: "Motyw Wsi", description: "Idealizacja lub krytyka życia wiejskiego i chłopstwa", books: ["wesele", "chlopi"], aliases: ["wieś", "wies", "motyw wsi", "życie na wsi"], images: [{ src: "images/motywy/wies/teodor_axentowicz_kolomyjka-jpg.jpg" }], poems: [ { author: "Kasprowicz", title: "Z chałupy", src: "images/motywy/wies/Kasprowicz_Z_chałupy.txt" },] },
    { id: "motywzla", name: "Motyw Zła", description: "Obecność destrukcyjnych sił w świecie i człowieku", books: ["magbet", "innyswiat", "gaz"], aliases: ["zło", "zlo", "motyw zła", "motyw zla"], images: [{ src: "images/motywy/zlo/eugene_delacroix-jpg.jpg" }], poems: [ { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/zlo/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywzbrodni", name: "Motyw Zbrodni", description: "Przekroczenie norm moralnych i jego konsekwencje", books: ["magbet", "zbrodniaikara", "gaz"], aliases: ["zbrodnia", "motyw zbrodni", "przestępstwo", "przestepstwo"], images: [{ src: "images/motywy/zbrodnia/pierre_paul_prudhon-jpg.jpg" }], poems: [ { author: "", title: "baczynski-elegia-o-chlopcu-polskim", src: "images/motywy/zbrodnia/baczynski-elegia-o-chlopcu-polskim.txt" },] },
    { id: "motywzdrady", name: "Motyw Zdrady", description: "Złamanie lojalności wobec bliskich, idei lub ojczyzny", books: ["1984", "potop"], aliases: ["zdrada", "motyw zdrady", "nielojalność", "nielojalnosc"], images: [{ src: "images/motywy/zdrada/DoVFE8egCJ7xf03wXkXAPEb9puV8AzDk.jpeg" }], poems: [ { author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/zdrada/mickiewicz_reduta_ordona.txt" },] },
    { id: "motywzemsty", name: "Motyw Zemsty", description: "Pragnienie odwetu prowadzące do konfliktu i destrukcji", books: ["iliada"], aliases: ["zemsta", "motyw zemsty", "odwet"], images: [{ src: "images/motywy/zemsta/artemisia-gentileschi_judyta-holofernes.jpg" }], poems: [{ author: "Mickiewicz", title: "reduta ordona", src: "images/motywy/zemsta/mickiewicz_reduta_ordona.txt" },] },
  ]
};
